...
export const GoogleIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M12.48 10.92v3.28h7.84c-.24 1.84-2.52 5.36-7.84 5.36-4.56 0-8.28-3.76-8.28-8.36s3.72-8.36 8.28-8.36c2.6 0 4.36 1.08 5.36 2.04l2.6-2.6c-1.68-1.56-3.84-2.52-7.96-2.52-5.52 0-10 4.48-10 10s4.48 10 10 10c5.76 0 9.6-4.04 9.6-9.76 0-.64-.08-1.12-.16-1.6h-9.44z" />
  </svg>
);
